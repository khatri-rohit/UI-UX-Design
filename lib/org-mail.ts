...
export async function sendOrgInviteEmail(params: {
  ...
  await transporter.sendMail({
    ...
    text: [
      `You have been invited to join "${params.orgName}" on LOGIC as a team member.`,
      "",
    ...
    html: `
      <div style="font-family: -apple-system, sans-serif; max-width: 560px; margin: 0 auto; padding: 32px 24px;">
        <p style="font-size: 20px; font-weight: 700; margin: 0 0 8px;">You're invited to join ${params.orgName}</p>
        <p style="color: #555; margin: 0 0 24px;">${params.inviterEmail} has invited you to join their organisation on LOGIC.</p>
        ...
        <a href="${params.acceptUrl}" style="display:inline-block;background:#000;color:#fff;padding:12px 28px;border-radius:6px;text-decoration:none;font-weight:600;">Accept Invitation</a>
